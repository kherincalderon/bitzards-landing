...
export const HeroSection = ({ content }: { content: HeroContent }) => (
  <section className="bg-dark-blue py-32 text-center overflow-hidden aurora-background">
    <div className="max-w-4xl mx-auto px-6 relative z-10">
      <h1 className="text-4xl md:text-7xl font-bold">
        <span
          className="text-gradient-primary"
          data-text={content.headlineGradient}
        >
          {content.headlineGradient}
        </span>
        <br />
        <span className="text-primary-text">{content.headlineWhite}</span>
      </h1>
